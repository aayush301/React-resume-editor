  ...
  return (
    <>
      <div className="relative inline-block w-full" ref={dropdownRef}>
        <button onClick={toggleDropdownMenu} id={id} className="flex justify-between w-full mt-2 px-3 py-2 text-gray-500 rounded-[4px] border-2 border-gray-100 active:border-sky-500 focus:border-sky-500 outline-none transition hover:border-gray-300">
