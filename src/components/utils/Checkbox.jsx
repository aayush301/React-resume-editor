      ...
      <label htmlFor={id} className='inline-flex items-center cursor-pointer'>
        <span className='relative w-10 h-10 p-2 rounded-full transition hover:bg-gray-100'>
          ...
          {isIndeterminate ? (
            ...
            <svg className="w-6 h-6 absolute z-10 fill-gray-400" focusable="false" aria-hidden="true" viewBox="0 0 24 24"> <path d="M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"></path></svg>
          )}
